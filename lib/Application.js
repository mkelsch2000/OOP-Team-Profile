...
Questions.prototype.getGithub = function() {
  inquirer
   ...
   .then (({ github }) => {
     this.engineer = new Engineer(this.employee.name, this.employee.id, this.employee.email, github);
...
Questions.prototype.getSchool = function() {
  inquirer
    ...
    .then (({ school }) => {
      this.intern = new Intern(this.employee.name, this.employee.id, this.employee.email, school);
